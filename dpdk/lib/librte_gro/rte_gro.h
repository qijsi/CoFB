...
#define RTE_GRO_MAX_BURST_ITEM_NUM 8192U
...
uint16_t rte_gro_dplane_reassemble(struct rte_mbuf **pkts, uint16_t nb_pkts,
                                   ...
                                   Skiplist *skiplist, struct fdir_hashtable *htable);

uint16_t rte_gro_reassemble(struct rte_mbuf **pkts,
		uint16_t nb_pkts,
		void *ctx);

uint32_t rte_gdp_reassemble(struct gdp_flowtable *ht, struct rte_mbuf **pkts, uint16_t nb_pkts,
...
uint16_t rte_gro_dplane_flush(void *ctx, 
                              uint64_t gro_types, struct rte_mbuf **out,
                              uint16_t max_nb_out, struct fdir_hashtable *htable, uint32_t fdir_id);
